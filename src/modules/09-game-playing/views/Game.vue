    ...
    export default {
        ...
        methods: {
            ...
            updateDBVals: function () {
                ...
                this.$db.ref('/Users/' + (this.$cookies.get('user').key) + '/gamesPlayed').set((this.storeUser.gamesPlayed));
            },
            updateCorrectAnswers: function () {
                this.storeUser.correctQuestions++;
                this.$db.ref('/Users/' + (this.$cookies.get('user').key) + '/correctQuestions').set((this.storeUser.correctQuestions));
            },
            updateIncorrectAnswers: function () {
                this.storeUser.incorrectQuestions++
                this.$db.ref('/Users/' + (this.$cookies.get('user').key) + '/incorrectQuestions').set((this.storeUser.incorrectQuestions));
            }
        }
    };
</script>
